...
Mam nadzieje ze nie walnąłem jakiejś gafy :D Rozdzieliłem to na parę funkcji i je otypowałem, dodatkowo przekazałem te funkcje jako "zaleznosc" w obiekcie :) Wydaje mi się ze fajnie i czytelnie to wygląda chociaz nie wiem czy za bardzo nie poleciałem z funkcja `applyShowOnHomeCriteria` :D Z góry dzięki za poświęcony czas!
